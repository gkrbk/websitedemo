...
// Recipients
$fromEmail = 'no-reply@acbysamllc.com'; // Email address that will be in the from field of the message.
$fromName = 'AC by Sam LLC: Message - Website Contact Form'; // Name that will be in the from field of the message.
$sendToEmail = 'georgekangr@gmail.com'; // Email address that will receive the message with the output of the form
$sendToName = 'Sam - Company Owner'; // Name that will receive the message with the output of the form

// Subject
$subject = 'Message from AC by Sam LLC Website contact form';
...
try {
  ...
  $mail->addBCC('contact@gkrdevelopment.com', 'Spam/Junk Filtering');
