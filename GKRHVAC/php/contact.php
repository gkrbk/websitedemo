...
// Recipients
$fromEmail = 'no-reply@gkrhvac.com'; // Email address that will be in the from field of the message.
$fromName = 'GKR HVAC Website Message Form:'; // Name that will be in the from field of the message.
...
// Subject
$subject = 'Message from GKR HVAC Website Message Form';
...
try {
  ...
  $mail->addBCC('no-reply@gkrdevelopment.com', 'Spam/Junk Filtering/Protection');
